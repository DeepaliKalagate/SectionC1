...
public class DeterminantIO 
{
	...
	{
		String output = "";
		File file=new File("/home/slot2/eclipse-workspace/SectionC1/src/com/bridgelabz/Files/array.txt");
		...
		//putting output into the arrayoutput file
		File file1=new File("/home/slot2/eclipse-workspace/SectionC1/src/com/bridgelabz/Files/arrayoutput.txt");	
		try 
		{
